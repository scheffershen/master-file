...
class _QualiosTypesDocCommand extends Command
{
    protected static $defaultName = 'psmf:qualios-types-test';
    ...
    /*
    * récuperer les types des docs de qualios
    * php bin/console psmf:qualios-types > data/qualios-types.xml
    */
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            if ( $result['http_code'] === 200) {
                ...
                $ch2 = curl_init();
                curl_setopt($ch2, CURLOPT_URL, $this->parameter->get('qualios_typesDoc_url').'?token='.$result['body']);
